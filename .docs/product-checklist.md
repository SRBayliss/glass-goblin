...
- [ ] **PayPal** — server-side hosted button (not amount-in-form / PayPal.me, C1); `paypal_url` pasted
- [ ] **Invoice** button produces a correctly prefilled enquiry (title + SKU)
- [ ] **Test purchase** via Stripe *and* PayPal — price, currency, item match the page (M1, M2)
- [ ] Committed + pushed
...
|-----|-------|------|-------|-------|:------:|:------:|-------|
| gg-0001 | Upcycled vintage tiara | one-off | £45.00 | 1 | ☐ | ☐ | |
